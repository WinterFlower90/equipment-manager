package com.pje.equipmentmanager.configure;
...
public class SwaggerConfig {
    ...
    private final String TITLE_FIX = "기자재 관리 대장 API ";
    ...
    public Docket apiV1() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName(version)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.pje.equipmentmanager"))
